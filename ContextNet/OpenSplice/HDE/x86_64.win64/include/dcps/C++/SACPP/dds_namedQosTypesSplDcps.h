...
extern SACPP_API c_bool __DDS_NamedDomainParticipantQos__copyIn(c_base base, struct DDS::NamedDomainParticipantQos *from, struct _DDS_NamedDomainParticipantQos *to);
extern SACPP_API void __DDS_NamedDomainParticipantQos__copyOut(void *_from, void *_to);
struct _DDS_NamedDomainParticipantQos {
    c_string name;
...
extern SACPP_API c_bool __DDS_NamedPublisherQos__copyIn(c_base base, struct DDS::NamedPublisherQos *from, struct _DDS_NamedPublisherQos *to);
extern SACPP_API void __DDS_NamedPublisherQos__copyOut(void *_from, void *_to);
struct _DDS_NamedPublisherQos {
    c_string name;
...
extern SACPP_API c_bool __DDS_NamedSubscriberQos__copyIn(c_base base, struct DDS::NamedSubscriberQos *from, struct _DDS_NamedSubscriberQos *to);
extern SACPP_API void __DDS_NamedSubscriberQos__copyOut(void *_from, void *_to);
struct _DDS_NamedSubscriberQos {
    c_string name;
...
extern SACPP_API c_bool __DDS_NamedTopicQos__copyIn(c_base base, struct DDS::NamedTopicQos *from, struct _DDS_NamedTopicQos *to);
extern SACPP_API void __DDS_NamedTopicQos__copyOut(void *_from, void *_to);
struct _DDS_NamedTopicQos {
    c_string name;
...
extern SACPP_API c_bool __DDS_NamedDataWriterQos__copyIn(c_base base, struct DDS::NamedDataWriterQos *from, struct _DDS_NamedDataWriterQos *to);
extern SACPP_API void __DDS_NamedDataWriterQos__copyOut(void *_from, void *_to);
struct _DDS_NamedDataWriterQos {
    c_string name;
...
extern SACPP_API c_bool __DDS_NamedDataReaderQos__copyIn(c_base base, struct DDS::NamedDataReaderQos *from, struct _DDS_NamedDataReaderQos *to);
extern SACPP_API void __DDS_NamedDataReaderQos__copyOut(void *_from, void *_to);
struct _DDS_NamedDataReaderQos {
    c_string name;
