...
set JARFILE=saj_helloworld_types.jar
set MANIFEST=saj_helloworld_types.manifest
...
del /f/s/q HelloWorldData\*.java  2>nul
...
echo "..\..\..\..\..\bin\idlpp" -I "..\..\..\..\..\etc\idl" -l java ..\..\idl\HelloWorldData.idl
...
echo javac -cp "classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ HelloWorldData\*.java
javac -cp "classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ HelloWorldData\*.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
